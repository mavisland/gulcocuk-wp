...
function declOfNum(number,titles,lang){switch(lang){case'rus':cases=[2,0,1,1,1,2];return titles[(number%100>4&&number%100<20)?2:cases[(number%10<5)?number%10:5]];case'eng':return titles[(number==1)?0:1];}}})(jQuery);jQuery(document).ready(function(){$('#course_timer').syotimer({year:2017,month:12,day:9,hour:20,minute:30,});});jQuery(document).ready(function(){$('#simple_timer').syotimer({year:2017,month:12,day:9,hour:20,minute:30,});});