...
if ( ! function_exists( 'gulcocuk_setup' ) ) :
	...
	function gulcocuk_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'gulcocuk' ),
		) );
 ...
 */
function gulcocuk_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'gulcocuk' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'gulcocuk' ),
...
add_action( 'widgets_init', 'gulcocuk_widgets_init' );
